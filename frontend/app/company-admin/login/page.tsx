...
import { companyLogin } from "../../../lib/adminApi";
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-gray-100 to-slate-200 p-4">
      <form
        ...
        className="w-full max-w-sm bg-white rounded-2xl p-8 shadow-xl border border-gray-200"
      >
        <h1 className="text-xl font-semibold text-gray-900 mb-1">
          Company Admin Login
        </h1>
        <p className="text-sm text-gray-500 mb-6">Tenant operations workspace</p>
        {error && (
        ...
        <label className="block mb-4">
          ...
          <input
            ...
            required
            className="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
          />
        </label>
